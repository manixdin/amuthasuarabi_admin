            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="page-title-box">
                                                <div class="page-title-right">
                                                    <button style="border-radius: 17px;" class="btn btn-success" id="New_Category"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;New City</button>
                                                </div>
                        ...
                        <form class="form-material form-horizontal" name="City_form" id="City_form">
                           <div class="card-body">
                              ...
                              <div class="form-group row">
                                 ...
                                 <div class="col-sm-12">
                                    ...
                                    <p class="error state_id"></p>
                                 </div>   

                                 <div class="col-sm-12">
                                    <label for="cono1" class="col-sm-12 text-left control-label col-form-label">City Name</label>
                                    <div class="col-sm-12">
                                       <input class="form-control" name="city_name" id="city_name" placeholder="Enter City Name">
                                    </div>
                                    <p class="error city_name"></p>
                                 </div>   
                           ...
                           <div class="border-top">
                              <div class="card-body" style="float:right;">
                                 <button type="button" class="btn btn-primary" id="City_button">Submit</button>
                ...
                <div id="page-wrapper">
                    ...
                    <script src="<?php echo base_url();?>custom/city.js"></script>
